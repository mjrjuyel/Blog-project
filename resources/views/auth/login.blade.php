            ...
            <div class="auth-fluid-form-box">
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}" entype="">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="checkboxs">Remember me</label>
                                </div>
                            </div>
...
<!-- Mirrored from coderthemes.com/hyper/saas/pages-login-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jun 2022 10:15:03 GMT -->
</html>