...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('contents/admin') }}/assets/css/vendor/jquery-jvectormap-1.2.2.css" />
    ...
    <div class="wrapper">
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarUser">
                            <ul class="side-nav-second-level">
                                ...
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#roleUser" aria-expanded="false"
                                        aria-controls="roleUser">
                                        <span> Role </span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="collapse" id="roleUser">
                                        <ul class="side-nav-third-level">
                                            <li>
                                                <a href="{{ url('dashboard/user/role') }}">All
                                                    Role</a>
                                            </li>
                                            <li>
                                                <a href="{{ url('dashboard/user/role/add') }}">Add
                                                    Role</a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarManage">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="{{ url('dashboard/basic') }}">Basic User</a>
                                </li>
                                <li>
                                    <a href="{{ url('dashboard/social') }}">Social Media</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#BlogSideBar" aria-expanded="false"
                            aria-controls="BlogSideBar" class="side-nav-link">
                        ...
                        <div class="collapse" id="BlogSideBar">
                            <ul class="side-nav-second-level">
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#CategorySideBar" aria-expanded="false"
                                    ...
                                    <div class="collapse" id="CategorySideBar">
                                        <ul class="side-nav-third-level">
                                            <li>
                                                <a
                                                    href="{{ url('dashboard/blog/category') }}">All</a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ url('dashboard/blog/category/add') }}">Add</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#sidebarTag" aria-expanded="false"
                                    ...
                                    <div class="collapse" id="sidebarTag">
                                        <ul class="side-nav-third-level">
                                            <li>
                                                <a href="{{ url('/dashboard/blog/tag') }}">All
                                                    Tag</a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ url('/dashboard/blog/tag/add') }}">Add
                                                    Tag</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="side-nav-item">
                                    ...
                                    <div class="collapse" id="sidebarPost">
                                        <ul class="side-nav-third-level">
                                            <li>
                                                <a href="{{ url('/dashboard/blog/post') }}">All
                                                    Post</a>
                                            </li>
                                            <li>
                                                <a
                                                    href="{{ url('/dashboard/blog/post/add') }}">Add
                                                    Post</a>
                                            </li>
                                        </ul>
                                    </div>
        ...
        <div class="content-page">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown"
                                ...
                                <span class="account-user-avatar">
                                    <img src="{{ asset('uploads/admin/user/avatar.png') }}"
                                        style="object-fit: cover;" alt="user-image" class="rounded-circle">
                                </span>
                                <span>
            ...
            <div class="container-fluid">
                ...
                @yield('script')
                <script src="{{ asset('contents/admin') }}/assets/js/vendor/apexcharts.min.js">
                </script>
                <script
                ...
                <script src="{{ asset('contents/admin') }}/assets/js/pages/demo.dashboard.js">
                </script>
