    ...
    <div class="container">
        <div class="row align-items-stretch retro-layout-2">
            <div class="col-md-4">
                ...
                <a href="{{ url('post/view/'. $post->post_slug)}}" class="h-entry mb-30 v-height gradient"
            ...
            <div class="col-md-4">
                ...
                <a href="{{ url('post/view/'. $post->post_slug)}}" class="h-entry img-5 h-100 gradient"
                    style="background-image: url('{{ asset('uploads/admin/post/'.$post->post_pic1) }}');">
                    <div class="text">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="entry2">
                        ...
                        <div class="excerpt">
                            ...
                            <h2><a href="{{url('post/view/'.$data->post_slug)}}">{{ $data->post_title }}</a></h2>
    ...
    <div class="container">
        <div class="row align-items-stretch retro-layout">
           ...
           <div class="col-md-5 order-md-2">
                <a href="{{ url('post/view/'. $post->post_slug)}}" class="hentry img-1 h-100 gradient"
                    style="background-image: url('{{ asset('uploads/admin/post/'.$post->post_pic1) }}');">
           ...
           @endforeach
            ...
            <div class="col-md-7">
               @foreach($lastFooterPost as $post)
                <a href="{{ url('post/view/'. $post->post_slug)}}" class="hentry img-2 v-height mb30 gradient"
                    style="background-image: url('{{ asset('uploads/admin/post/'.$post->post_pic1) }}');">
                ...
                <div class="two-col d-block d-md-flex">
                    ...
                    <a href="{{ url('post/view/'. $post->post_slug)}}" class="hentry v-height ml-auto img-2 gradient"
                        style="background-image: url('{{ asset('uploads/admin/post/'.$post->post_pic1) }}');">
