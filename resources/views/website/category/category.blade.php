             ...
             <div class="container">
                 <div class="row">
                     <div class="col-lg-4 mb-4">
                         <div class="entry2">
                             <a href="single.html"><img src="{{asset('contents/website')}}/assets/images/img_1.jpg" alt="Image"
                                     class="img-fluid rounded"></a>
                             <div class="excerpt">
                                 <span class="post-category text-white bg-secondary mb-3">Politics</span>
                                 <h2><a href="single.html">The AI magically removes moving objects from videos.</a></h2>
                                 <div class="post-meta align-items-center text-left clearfix">
                                     <figure class="author-figure mb-0 mr-3 float-left"><img src="{{asset('contents/website')}}/assets/images/person_1.jpg"
                     ...
                     <div class="col-lg-4 mb-4">
                         <div class="entry2">
                             <a href="single.html"><img src="{{asset('contents/website')}}/assets/images/img_2.jpg" alt="Image"
                                     class="img-fluid rounded"></a>
                             <div class="excerpt">
                     ...
                     <div class="col-lg-4 mb-4">
                         <div class="entry2">
                             <a href="single.html"><img src="{{asset('contents/website')}}/assets/images/img_3.jpg" alt="Image"
                                     class="img-fluid rounded"></a>
                             <div class="excerpt">
                     ...
                     <div class="col-lg-4 mb-4">
                         <div class="entry2">
                             <a href="single.html"><img src="{{asset('contents/website')}}/assets/images/img_4.jpg" alt="Image"
                                     class="img-fluid rounded"></a>
                             <div class="excerpt">
